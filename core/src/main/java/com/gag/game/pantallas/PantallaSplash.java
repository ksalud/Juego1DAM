...
public class PantallaSplash extends Pantalla{
    ...
    public PantallaSplash() {
        ...
        posicionBarra=new Vector2(juego.getAncho()/2-barra.getWidth()/2, juego.getAlto()/2-barra.getHeight()/2);
        posicionPiloto=new Vector2(juego.getAncho()/2-piloto.getWidth()/2, juego.getAlto()/2-piloto.getHeight()/2);
	...
	am.load("Fondo.jpg", Texture.class);
        ...
        //Esto que sigue es BASURA para alargar la carga que HAY QUE BORRAR y también ELIMINAR DE LOS ASSETS
    }
    ...
    public void actualizar(float delta) {
        ...
        if(posicionPiloto.x-posicionBarra.x >= barra.getWidth() - 75){//10 -> piloto=8 borde=2
